...
typeof ctx (Add e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                       ...
                       _                      -> Nothing
typeof ctx (Sub e1 e2) = case (typeof ctx e1, typeof ctx e2) of --sub 
                       (Just TNum, Just TNum) -> Just TNum 
                       _                      -> Nothing
typeof ctx (And e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                       (Just TBool, Just TBool) -> Just TBool 
                       _                        -> Nothing 
typeof ctx (Or e1 e2) = case (typeof ctx e1, typeof ctx e2) of -- adicionado or
                       (Just TBool, Just TBool) -> Just TBool 
                       _                        -> Nothing
...
typeof ctx Nil = Just (TList TNum)
